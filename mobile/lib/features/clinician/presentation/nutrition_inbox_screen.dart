...
class _InboxHeader extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Row(
      children: [
        // Pushed from the doctor's home now that Nutrition is not a tab, so it
        // needs a way back that is not only a system gesture.
        // Navigator rather than GoRouter's extension, which throws where no
        // router is above the screen.
